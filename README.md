...
# Zipkin Download url (zipkin-server-x.x.x-exec.jar)
...
- Admin ACCESS
![KEYCLOAK Token Testing ](https://github.com/HarshaPrimeTrainings/SpringBootandMicroserviceswithSpringCloud_90/blob/main/adminacces.PNG)
...
# Eureka Communication inside Docker
- Note: When services run inside Docker containers, use the Docker service name for communication between services and with Eureka.
- eureka.client.service-url.defaultZone=http://service3:8761/eureka
