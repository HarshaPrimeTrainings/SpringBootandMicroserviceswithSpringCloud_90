...
public class UserService {
	...
	public Integer getUserCountofAddr(String addr) {
		return repo.getUserCountofAddr(addr);
	}
	
	public Integer getUserCountofAddrJPQL(String addr) {
		return repo.getUserCountofAddrjpql(addr);
	}
	
	public List<User> getUsersofAddrJPQL(String addr) {
		return repo.getUseofAddrjpql(addr);
	}
